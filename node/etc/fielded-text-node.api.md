## API Report File for "@pbkware/fielded-text-node"
...
export class FtNodeMetaSerialization extends FtMetaSerialization {
    deserializeFromFile(filePath: PathOrFileDescriptor, warnings?: string[], encoding?: BufferEncoding, format?: FtMetaSerializationFormat): FtMeta;
